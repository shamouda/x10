...
public class LocalViewResilientExecutorDS {
    ...
    class PlaceTempData {
        ...
        val snapshots:Rail[ResilientMap];
        ...
        private def this(snapshots:Rail[ResilientMap], checkTimes:ArrayList[Long], checkAgreeTimes:ArrayList[Long], 
        ...
        public def this(snapshots:Rail[ResilientMap]){
    ...
    public def run(app:LocalViewResilientIterativeAppDS, startRunTime:Long) {
        ...
        val root = here;
        val hm1 = DataStore.getInstance().makeResilientMap("hm1");
        Console.OUT.println("LocalViewResilientExecutorDS: hm1 created ...");
        val hm2 = DataStore.getInstance().makeResilientMap("hm2");
        Console.OUT.println("LocalViewResilientExecutorDS: hm2 created ...");
        val snapshots = (isResilient)?[hm1,hm2]:null;
