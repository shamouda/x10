 ...
 */
abstract class FinishResilientPessimistic extends FinishResilient implements CustomSerialization {
    ...
    final class PessimisticFinishRemote extends FinishResilientPessimistic {
    ...
    final class PessimisticFinishRootMaster extends FinishResilientPessimistic {
	    def notifySubActivitySpawn(dstPlace:Place):void {
    ...
    final class PessimisticFinishRootBackup extends FinishResilientPessimistic {
