...
public class SimpleResTxBench {
    ...
    public static def main(args:Rail[String]) {
        ...
        if (w == -1) {
            ...
            runIteration(store, p, w, r, u, t, h, o, g, f, null, throughputPLH, null);
            resetStatistics(store, throughputPLH);
        ...
        try {
            for (iter in 1..n) {
                ...
                if (victim.onePerIteration)
                    ...
                    victim = victimsList;
                runIteration(store, p, d, r, u, t, h, o, g, f, victim, throughputPLH, null);
                Console.OUT.println("iteration:" + iter + " completed, iteration elapsedTime ["+(Timer.milliTime() - startIter)+"]  ms ");

                printThroughput(store, p, iter, throughputPLH, d, t, h, o);
                resetStatistics(store, throughputPLH);
            }
    ...
    public static def runIteration(store:TxStore, producersCount:Long, 
        ...
        try {
            ...
            finish for (var i:Long = 0; i < producersCount; i++) {               
                startPlace(activePlaces(i), store, activePlaces.size(), producersCount, 
                        d, r, u, t, h, o, g, f, victims, throughput, recoveryThroughput);
            }
    ...
    private static def startPlace(pl:Place, store:TxStore, activePlacesCount:Long, producersCount:Long, 
            d:Long, r:Long, u:Float, t:Long, h:Long, o:Long, g:Long, f:Boolean, victims:VictimsList, 
            throughput:PlaceLocalHandle[PlaceThroughput], recoveryThroughput:PlaceThroughput) {
        ...
        at (pl) async {
            ...
            for (thrd in 1..t) async {
                produce(store, activePlacesCount, myVirtualPlaceId, producersCount, 
                        thrd-1, d, r, u, t, h, o, g, f, victims, throughput);
            }
    ...
    public static def produce(store:TxStore, activePlacesCount:Long, myVirtualPlaceId:Long, producersCount:Long, producerId:Long, 
            d:Long, r:Long, u:Float, t:Long, h:Long, o:Long, g:Long, f:Boolean, victims:VictimsList,
    ...
    public static def resetStatistics(store:TxStore, plh:PlaceLocalHandle[PlaceThroughput]) {
