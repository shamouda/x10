...
public class ResilientTxBenchRail(plh:PlaceLocalHandle[TxBenchState]) implements MasterWorkerApp {
    ...
    public static def main(args:Rail[String]) {
        ...
        val pointsPerPlace = r/p;
        val plh = PlaceLocalHandle.make[TxBenchState](Place.places(), ()=> new TxBenchState(here.id, r, u, n, p, t, w, d, h, o, g, s, f, vp, vt) );
        val app = new ResilientTxBenchRail(plh);
        val executor = MasterWorkerExecutor.makeRail(activePlaces, app, pointsPerPlace, (i:Long)=> {return 0;});
        if (i > 0.0F) {
        ...
        if (recovery) {
            ...
            finish at (leftPlace) async {
                ...
                if (masterState.rightPlaceDeathTimeNS == -1) {
                    Console.OUT.println(here + " ResilientTxBenchRail Assertion Error: place did not receive suicide note ...");
                    System.killHere();
                }
