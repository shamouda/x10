...
public class DummyRandomAccess {
    ...
    public static def main(args:Rail[String]) {
        ...
        val accountsMAX = accountsPerPlace * mgr.activePlaces().size();
        val requestsMap = new HashMap[Long,PlaceUpdateRequests]();
        var expectedSum:Long = 0;
        for (p in mgr.activePlaces()) {
        ...
        try {
            ...
            randomUpdate(mgr.activePlaces(), accountsPerPlace, updatesPerPlace, debugProgress, requestsMap);
    ...
    public static def randomUpdate(activePG:PlaceGroup, accountsPerPlace:Long, 
