...
public class DummyFinishUncountAsyncInnerFinish {
    public static def main(args:Rail[String]) {
        ...
        Console.OUT.println("Starting DummyFinishUncountAsyncInnerFinish benchmark - repeat="+repeat);
        val start = System.nanoTime();
        finish for (p in Place.places()) at (p) async {
            val rand = new Random(System.nanoTime());
            finish for (i in 1..repeat) {
