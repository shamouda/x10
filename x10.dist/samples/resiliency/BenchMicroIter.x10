...
public class BenchMicroIter {
    ...
    public static def main(args:Rail[String]){here==Place.FIRST_PLACE}{
        ...
        if (needsWarmup()) {
            ...
            doTest(refTime, "warmup", think, false, MIN_ITER/2);
            Console.OUT.println("Warmup complete");
        }
        
        Console.OUT.println("Test based from place 0");
        doTest(refTime, "place 0 -- ", think, true, MIN_ITER);
        Console.OUT.println();

        /*Console.OUT.println("Test based from place 1");
        at (Place(1)) doTest(refTime, "place 1 -- ", think, true, MIN_ITER);
        Console.OUT.println();*/
    }
    ...
    public static def doTest(refTime:Long, prefix:String, t:Long, print:Boolean, minIter:Long) {
